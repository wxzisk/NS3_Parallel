...
//kaihui: subnet scope under parallel and distributed simulation
...
int main(int argc, char *argv[])
{
	...
	//kaihui: parallel and distributed simulation setup
	bool nullmsg = false;
	...
	Simulator::Run();
	Simulator::Destroy();
	MpiInterface::Disable(); //kaihui: Distributed simulation setup
	NS_LOG_INFO("Done.");
	fclose(trace_output);
